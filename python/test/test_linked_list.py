...
class TestLinkedList:
    def test_init_with_no_head(self):
    ...
    def test_add_to_single_node_list(self):
    ...
    def test_add_with_different_data_types(self):
    ...
    def test_add_to_empty_list_raises_error(self):
